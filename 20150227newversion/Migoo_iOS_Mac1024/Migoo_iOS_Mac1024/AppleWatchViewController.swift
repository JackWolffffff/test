...
//  Migoo_iOs_Mac1024
//
//  Created by rongjun on 15/4/7.
//  Copyright (c) 2015年 Migoo. All rights reserved.
//

import UIKit

class AppleWatchViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UIAlertViewDelegate {

    var tableData:Array<MigooRSS> = []
    var parseUrl = url_AppleWatch
    let TAG_IMAGE = 1
